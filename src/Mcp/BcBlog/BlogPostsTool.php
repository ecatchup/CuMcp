            ...
            ->withTool(
                ...
                inputSchema: [
                    ...
                    'properties' => [
                        ...
                        'eyeCatch' => ['type' => 'string', 'description' => 'アイキャッチ画像。100KB以下の小さなファイルの場合はbase64データ形式（data:image/jpeg;base64,iVB...）、100KB以上の大きなファイルの場合は事前にsendFileChunkツールで分割アップロード後にファイル名を指定、または外部画像URLを直接指定'],
                    ],
