...
/**
 * テスト時のMCPサーバーの起動に利用するが、
 * ユニットテストの処理自体は、tests/bootstrap.phpで行うため、ここでは、処理を終了する
 */
if(\BaserCore\Utility\BcUtil::isTest()) return;
...
*/
/**
 * ユニットテストの bootstrap.php で読み込まれており、キーの重複エラーとなるためスキップ
 */
